...
func nvproxyRegisterDevices(info *containerInfo, vfsObj *vfs.VirtualFilesystem, nvidiaDriverVersion nvconf.DriverVersion) error {
	...
	devInfo, err := nvproxy.Register(vfsObj, &nvproxy.Options{
		...
		GPUHostSwapLimit:       info.conf.NVProxyGPUHostSwapLimit,
		MaxTimesliceUs:         info.conf.NVProxyMaxTimesliceUs,
		SetTimesliceUs:         info.conf.NVProxySetTimesliceUs,
		SetInterleaveLevel:     info.conf.NVProxySetInterleaveLevel,
		MinComputePreemption:   minComputePreemption,
		Preempt:                info.conf.NVProxyGPUPreempt,
		Unschedule:             info.conf.NVProxyGPUUnschedule,
