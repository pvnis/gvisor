		...
		v535_104_05 := addUnsupportedDriverABI(535, 104, 05, func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV2080_CTRL_CMD_GR_SET_CTXSW_PREEMPTION_MODE:                     ctrlHandler(ctrlSetCtxswPreemptionMode, compUtil),
					...
					nvgpu.NVA06C_CTRL_CMD_SET_TIMESLICE:                                    ctrlHandler(ctrlSetTimeslice, compUtil),
				...
				getInfo: func() *DriverABIInfo {
					return &DriverABIInfo{
						...
						ControlInfos: map[uint32]IoctlInfo{
							...
							nvgpu.NV2080_CTRL_CMD_FB_GET_INFO_V2:                                   ioctlInfo("NV2080_CTRL_CMD_FB_GET_INFO_V2", nvgpu.NV2080_CTRL_FB_GET_INFO_V2_PARAMS{}),
							...
							nvgpu.NV2080_CTRL_CMD_GR_SET_CTXSW_PREEMPTION_MODE:                     ioctlInfo("NV2080_CTRL_CMD_GR_SET_CTXSW_PREEMPTION_MODE", nvgpu.NV2080_CTRL_GR_SET_CTXSW_PREEMPTION_MODE_PARAMS{}),
